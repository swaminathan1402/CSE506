...
int read(hba_port_t *port, uint32_t startl, uint32_t starth, uint32_t count, uint64_t *buffer);
int write(hba_port_t *port, uint32_t startl, uint32_t starth, uint32_t count, uint64_t *buffer);
#endif
